...
typedef struct _c_FUNCTION_Switch_msgTypeTag
{
...
} _c_FUNCTION_Switch_msgType;
typedef struct _c_TIMESTAMP_msgTypeTag
{
...
typedef union _c_FUNCTION_Switch_bufTag
{
  vuint8 _c[2];
  _c_FUNCTION_Switch_msgType FUNCTION_Switch;
} _c_FUNCTION_Switch_buf;
typedef union _c_TIMESTAMP_bufTag
{
  vuint8 _c[8];
  _c_TIMESTAMP_msgType TIMESTAMP;
} _c_TIMESTAMP_buf;
...
/* RAM CATEGORY 2 START */
V_MEMRAM0 extern  V_MEMRAM1 _c_FUNCTION_Switch_buf V_MEMRAM2 FUNCTION_Switch;
/* RAM CATEGORY 2 END */

/* RAM CATEGORY 2 START */
V_MEMRAM0 extern  V_MEMRAM1 _c_TIMESTAMP_buf V_MEMRAM2 TIMESTAMP;
/* RAM CATEGORY 2 END */
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <D:\code\SocCode\linux\gen2\Geny\drv_par.h> is different. Please check time and date of generated files!"
  #endif
#else
